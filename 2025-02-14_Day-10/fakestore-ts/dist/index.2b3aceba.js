...
})({"fJ4AV":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "deb4668a2b3aceba";
"use strict";
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getAllProducts", ()=>getAllProducts) // Only include DOMContentLoad event for main.js file or other (helper)js files too?
;
parcelHelpers.export(exports, "getCategories", ()=>getCategories);
parcelHelpers.export(exports, "updateCartProducts", ()=>updateCartProducts);
parcelHelpers.export(exports, "getCartItemsForUserID", ()=>getCartItemsForUserID);
parcelHelpers.export(exports, "getProductById", ()=>getProductById);
parcelHelpers.export(exports, "addProductToCart", ()=>addProductToCart);
parcelHelpers.export(exports, "emptyCart", ()=>emptyCart);
parcelHelpers.export(exports, "getProductsByCategory", ()=>getProductsByCategory);
parcelHelpers.export(exports, "getAllUsers", ()=>getAllUsers);
parcelHelpers.export(exports, "tryLoginForUser", ()=>tryLoginForUser);
parcelHelpers.export(exports, "getUserId", ()=>getIdOfLoggedInUser);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const fakeStoreAPI = (0, _axiosDefault.default).create({
...
const updateCartProducts = async (cartId, products)=>{
    const res = await fakeStoreAPI.patch(`/carts/${cartId}`, {
        products
    });
    return res.data;
};
const addProductToCart = async ({ userId, date, products })=>{
    const res = await fakeStoreAPI.post("/carts", {
        userId,
        date,
        products
    });
...
const tryLoginForUser = async ({ username, password })=>{
    const res = await fakeStoreAPI.post("/auth/login", {
        username,
        password
    });
    return res.data;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2dYp5":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const loggedInUser = {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fJ4AV","7QK8s"], "7QK8s", "parcelRequire94c2")

//# sourceMappingURL=index.2b3aceba.js.map
